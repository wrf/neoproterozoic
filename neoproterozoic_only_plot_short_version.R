...
pdf(file="~/git/neoproterozoic/neoproterozoic_plot_short.pdf", width=8, height=7)
#png(file="~/git/neoproterozoic/neoproterozoic_plot_short.png", width=800, height=700)
...
#cohendata = read.table("~/git/neoproterozoic/Cohen_Macdonald_2015_Mya_vs_WAD.tab", header=TRUE, sep="\t")
...
cohenpoints = read.table("~/git/neoproterozoic/Cohen_Macdonald_2015_fig5b_points.txt", header=TRUE, sep="\t")
...
crfractdata = read.table("~/git/neoproterozoic/chromium_fractions_2018.tab", header=TRUE, sep="\t")

axis(2, at=c(3.9, 4.5, 5.1, 5.7, 6.3, 6.9), labels=c("",0,"",1,"",2), cex.lab=0.9, cex.axis=0.9 )
...
rockcolors = c("#e1c96a88","#76767688","#76769688","#b7131388","#a6767688","#e1c96a88","#76967688","#e1c96a88","#b7131388")
rockcodes = match(crfractdata[["rock.type"]], rocktypes)
points(-cr_age[low_cr_values], cr_ratio[low_cr_values]/(2/3.5)+4.3, pch=16, cex=2, col=rockcolors[low_cr_values][rockcodes])
#unique(crfractdata[["rock.type"]])
legend(-940,6.9,legend=c("Carbonates","Shales","Ironstones"), pch=16, pt.cex=1.1, cex=1, col=c("#e1c96a","#767676","#b71313"), box.lwd=0.5)
#text(-1020,7,"B",pos=4,cex=1.5)
#mtext("C",side=2,las=1,cex=2, at=6.5,line=3.2)

modern_values = range(crfractdata[cr_age < 10,4]) / (2/3.5)+4.3
rect(-490,modern_values[1],-480,modern_values[2], col="#000000", border=FALSE)
...
#points(-brocks_age,brocks_sh/2+2.05, pch=15, cex=2, col="#2690bc99")
#legend(-940,3.5,legend=c("Sterane/hopane ratio"), pch=15, pt.cex=1.2, cex=0.9, col=c("#2690bc"), box.lwd=0.5 )
...
axis(2, at=c(0,1.2,2.4), labels=c(0,0.5,1))
lines(c(-1000,-500),c(0.0,0.0),lwd=0.3)
points(-brocks_age[has_steranes],c27_conc/(100/2.4), pch=18, cex=2, col="#cd0f3299")
points(-brocks_age[has_steranes],c28_conc/(100/2.4), pch=18, cex=2, col="#470fcd99")
points(-brocks_age[has_steranes],c29_conc/(100/2.4), pch=18, cex=2, col="#0fcd4b99")
...
points(-brocks_age[has_steranes],brockscambdata[["C27"]][has_steranes]/(100/2.4), pch=18, cex=2, col="#cd0f3299")
points(-brocks_age[has_steranes],brockscambdata[["C28"]][has_steranes]/(100/2.4), pch=18, cex=2, col="#470fcd99")
points(-brocks_age[has_steranes],brockscambdata[["C29"]][has_steranes]/(100/2.4), pch=18, cex=2, col="#0fcd4b99")

legend(-940,2.4,legend=c("C27","C28","C29"), pch=18, pt.cex=1.3, cex=1.1, col=c("#cd0f32","#470fcd","#0fcd4b"), box.lwd=0.5)
