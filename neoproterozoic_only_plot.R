...
pdf(file="~/git/neoproterozoic/neoproterozoic_plot.pdf", width=8, height=7)
...
legend(-940,6.4,legend=c("Carbonates","Shales","Ironstones"), pch=16, pt.cex=1.1, cex=0.9, col=c("#e1c96a","#767676","#b71313"), box.lwd=0.5)
...
legend(-940,1.7,legend=c("C27","C28","C29"), pch=18, pt.cex=1.3, cex=0.9, col=c("#cd0f32","#470fcd","#0fcd4b"), box.lwd=0.5)
